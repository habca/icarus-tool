...
class TestTechTree(unittest.TestCase):
    ...
    def test_hunting_rifle(self):
        ...
        self.assertEqual(calc.calculate("40 titanium_ingot"), calc.calculate(titanium_ingot1))
        self.assertEqual(calc.calculate("40 titanium_ingot"), titanium_ingot1)

        epoxy_1 = "8 sulfur + 16 tree_sap"
        epoxy_2 = "8 sulfur + 64 stick"
        epoxy_3 = "8 sulfur + 7 wood"

        self.assertEqual(calc.calculate("4 epoxy"), calc.calculate(epoxy_1))
        self.assertEqual(calc.calculate("4 epoxy"), calc.calculate(epoxy_2))
        self.assertEqual(calc.calculate("4 epoxy"), calc.calculate(epoxy_3))
        self.assertEqual(calc.calculate("4 epoxy"), epoxy_3)

        steel_screw1 = "1 steel_ingot"
        steel_screw2 = "6 iron_ore + 1 coal_ore"

        self.assertEqual(calc.calculate("16 steel_screw"), calc.calculate(steel_screw1))
        self.assertEqual(calc.calculate("16 steel_screw"), calc.calculate(steel_screw2))
        self.assertEqual(calc.calculate("16 steel_screw"), steel_screw2)
        ...
        self.assertEqual(calc.calculate("1 hunting_rifle"), calc.calculate(hunting_rifle1))
        self.assertEqual(calc.calculate("1 hunting_rifle"), calc.calculate(hunting_rifle2))
        self.assertEqual(calc.calculate("1 hunting_rifle"), hunting_rifle2)
    ...
    def test_electric_extractor(self):
        ...
        self.assertEqual(calc.calculate("20 iron_ingot"), calc.calculate(iron_ingot1))
        self.assertEqual(calc.calculate("20 iron_ingot"), iron_ingot1)
        ...
        self.assertEqual(calc.calculate("5 electronics"), calc.calculate(electronics1))
        self.assertEqual(calc.calculate("5 electronics"), calc.calculate(electronics2))
        self.assertEqual(calc.calculate("5 electronics"), calc.calculate(electronics3))
        self.assertEqual(calc.calculate("5 electronics"), calc.calculate(electronics4))
        self.assertEqual(calc.calculate("5 electronics"), electronics4)
        ...
        self.assertEqual(calc.calculate("3 electric_extractor"), calc.calculate(electric_extractor1))
        self.assertEqual(calc.calculate("3 electric_extractor"), calc.calculate(electric_extractor2))
        self.assertEqual(calc.calculate("3 electric_extractor"), electric_extractor2)
